...
class CardSizes {
  static Size front(BoxConstraints constraints) {
    return Size(constraints.maxWidth, constraints.maxHeight * 0.985);
  }

  static Size middle(BoxConstraints constraints) {
    return Size(constraints.maxWidth * 0.95, constraints.maxHeight);
  }
...
class CardAlignments {
  static Alignment front = Alignment(0.0, -1.0);
  static Alignment middle = Alignment(0.0, 1.0);
  static Alignment back = Alignment(0.0, 1.0);
}
